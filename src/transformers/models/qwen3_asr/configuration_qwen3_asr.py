...
class Qwen3ASRAudioEncoderConfig(PretrainedConfig):
    ...
    configuration with the defaults will yield a similar configuration to that of the audio encoder of the Qwen3-ASR
    architecture.
    ...
    Args:
        ...
        n_window (`int`, *optional*, defaults to 100):
            The chunk size for conv and flash attention in the AudioEncoder.
        output_dim (`int`, *optional*, defaults to 3584):
            The output dimension of AudioEncoder.
        n_window_infer (`int`, *optional*, defaults to 400):
            The chunk size for inference in the AudioEncoder.
        conv_chunksize (`int`, *optional*, defaults to 500):
            The chunk size for splitting convolution to avoid OOM.
        downsample_hidden_size (`int`, *optional*, defaults to 480):
            The hidden size of the 2D convolution downsampling layers.
...
class Qwen3ASRTextConfig(PretrainedConfig):
    r"""
    This is the configuration class to store the configuration of a [`Qwen3ASRThinkerTextModel`]. It is used to
    instantiate a Qwen3-ASR text model according to the specified arguments, defining the model architecture.
    ...
    Args:
        vocab_size (`int`, *optional*, defaults to 151936):
            Vocabulary size of the Qwen3ASR model. Defines the number of different tokens that can be represented by
            the `inputs_ids` passed when calling [`Qwen3ASRThinkerTextModel`].
    ...
    ```python
    >>> from transformers import Qwen3ASRTextConfig

    >>> # Initializing a Qwen3ASR text style configuration
...
class Qwen3ASRThinkerConfig(PretrainedConfig):
    r"""
    This is the configuration class to store the configuration of a [`Qwen3ASRThinkerForConditionalGeneration`]. It is
    used to instantiate a Qwen3-ASR-Thinker model according to the specified arguments, defining the model
    architecture. Instantiating a configuration with the defaults will yield a similar configuration to that of the
    thinker component of the Qwen3-ASR architecture.
    ...
    ```python
    >>> from transformers import Qwen3ASRThinkerConfig

    >>> # Initializing a default Qwen3ASRThinkerConfig
    >>> configuration = Qwen3ASRThinkerConfig()

    >>> # Accessing the model configuration
    >>> audio_config = configuration.audio_config
...
class Qwen3ASRConfig(PretrainedConfig):
    r"""
    This is the configuration class to store the configuration of a [`Qwen3ASRForConditionalGeneration`]. It is used to
    instantiate a Qwen3ASR model according to the specified sub-models configurations, defining the model architecture.
    ...
    Args:
        ...
        support_languages (`List[str]`, *optional*):
