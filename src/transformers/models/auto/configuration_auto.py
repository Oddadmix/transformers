...
CONFIG_MAPPING_NAMES = OrderedDict[str, str](
    [
        ...
        ("qwen3_asr_audio_encoder", "Qwen3ASRAudioEncoderConfig"),
        ("qwen3_asr_text", "Qwen3ASRTextConfig"),
...
MODEL_NAMES_MAPPING = OrderedDict[str, str](
    [
        ...
        ("qwen3", "Qwen3"),
        ("qwen3_asr", "Qwen3ASR"),
        ("qwen3_asr_audio_encoder", "Qwen3ASR AudioEncoder"),
        ("qwen3_asr_text", "Qwen3ASR Text"),
        ("qwen3_asr_thinker", "Qwen3ASR Thinker"),
        ("qwen3_5", "Qwen3_5"),
